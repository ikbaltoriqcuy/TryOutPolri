...
const testimonials: Testimonial[] = [
  {
    ...
    message:
      "“Dibimbing dengan baik di Police Course. Tutor dan Coachnya perhatian dan gak perhitungan waktu. Terima kasih Tactical Jaya selalu.”",
    ...
    >
      ...
      >
        ...
        <Grid
          ...
          xs={12}
          md={8}
          sx={{ bgcolor: "grey.900", color: "white", p: 4 }}
        >
          <StyledSliderBox
            sx={{
              display: "flex",
